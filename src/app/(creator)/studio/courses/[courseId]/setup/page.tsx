...
export default async function CourseSetupPage({
  ...
  return (
    <WorkspaceShell eyebrow="Course Setup" title={editable.course.title}>
      <p>
        Define the course identity, learner group, access realities, and early
        certificate intent before moving into Diagnosis.
      </p>
      ...
      <form action={saveAction} className="setup-form">
        ...
        <div className="form-grid">
          <label>
            <span>Language</span>
            <input name="language" required defaultValue={setup?.language || "English"} />
          </label>
          <label>
            <span>Format and time expectation</span>
            <input name="formatAndTime" required defaultValue={setup?.formatAndTime} />
          </label>
          <label>
            <span>Level</span>
          ...
          <label>
            ...
            <input name="capacityArea" required defaultValue={setup?.capacityArea} />
          </label>
        </div>
        <label>
        ...
        <fieldset>
          <legend>Learner reality</legend>
          <label>
            <span>Device access</span>
            <input name="deviceAccess" defaultValue={learnerReality.deviceAccess} />
          </label>
          <label>
            <span>Connectivity</span>
            <input name="connectivity" defaultValue={learnerReality.connectivity} />
          </label>
          <label>
            <span>Time available for learning</span>
            <input name="timeAvailable" defaultValue={learnerReality.timeAvailable} />
          </label>
        </fieldset>
